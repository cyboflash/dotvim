...
" Comments
syn region  asm8051Comment	start=";" end="$" contains=asm8051Todo
...
" SFRs
syn keyword asm8051Reg		a b psw dps dptr dpl dph dpl0 dph0 dpl1 dph1 
syn keyword asm8051Reg		ac c cbank
...
syn match   asm8051Directive	"\<FUNCTION\>"
